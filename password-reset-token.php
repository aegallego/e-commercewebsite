...
<?php
  ...
  if (isset($_POST['password-reset-token']) && isset($_POST['email'])) {
    ...
    if ($row) {
      ...
      <br>
      A unique link to reset your password has been generated for you.<br>
...
<br>
      ...
      if ($mail->Send()) {
        echo "We have sent password recovery instructions to your email.";
        echo "<br>";
        echo "<br>";
...
<?php
  ...
  echo "<a href='user_login.php'>Back to Login</a>"; 
?>
</body>
</html>